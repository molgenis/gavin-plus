...
public class Pipeline
{
			...
			HandleMissingCaddScores.Mode mode, File outputVcfFile, File labVariants, boolean verbose) throws Exception
	{
		...
		Iterator<RelevantVariant> rv3 = new MatchVariantsToGenotypeAndInheritance(rv2, cgdFile, td.getParents(),
				verbose).go();
		...
		Iterator<RelevantVariant> rve = new MakeRVCFforClinicalVariants(rv10, "rlvMetadata", verbose).addRVCFfield();
