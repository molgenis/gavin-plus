...
class WriteToRVCF
{
	...
	void writeRVCF(Iterator<GavinRecord> gavinRecords, File writeTo, File inputVcfFile, String version,
			String cmdString, boolean writeToDisk, boolean splitRlvField, boolean prefixRlvFields,
			boolean includeSamples) throws Exception
	{
