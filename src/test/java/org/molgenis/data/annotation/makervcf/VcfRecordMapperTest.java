...
public class VcfRecordMapperTest
{
	...
	public void testMapSplitRlv()
	{
		...
		assertEquals(mappedVcfRecord, new VcfRecord(vcfMeta,
				new String[] { "1", "123", "rs6054257;rs6040355", "GTC", "G,GTCT", "123.45", "q10;s50",
						"key0=val0;key1=val1;RLV_ALLELEFREQ=[A|gene0]0.1,[G|gene1]3.4;RLV_SAMPLEGENOTYPE=.;RLV_VARIANTGROUP=.;RLV_SAMPLEGROUP=.;RLV_FDR=.;RLV_PHENOTYPEINHERITANCE=.;RLV_ALLELE=[A|gene0]A,[G|gene1]G;RLV_VARIANTCOMPOUNDHET=.;RLV_GENE=[A|gene0]gene0,[G|gene1]gene1;RLV_PHENOTYPE=.;RLV_PHENOTYPEDETAILS=.;RLV_PHENOTYPEGROUP=.;RLV_VARIANTSIGNIFICANCE=[A|gene0]type0,[G|gene1]type1;RLV_VARIANTSIGNIFICANCEJUSTIFICATION=[A|gene0]my_reason_#0,[G|gene1]my_reason_#1;RLV_TRANSCRIPT=[A|gene0]transcript0,[G|gene1]transcript1;RLV_PRESENT=[A|gene0]TRUE,[G|gene1]TRUE;RLV_SAMPLESTATUS=.;RLV_VARIANTSIGNIFICANCESOURCE=[A|gene0]source0,[G|gene1]source1;RLV_PHENOTYPEONSET=.;RLV_SAMPLEPHENOTYPE=." }));
	}
